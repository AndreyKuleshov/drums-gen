  ...
  bars: [
    {
      time_sig: { num: 2, den: 4 },
      strokes: [
        { duration: '1/4', hand: 'R', accent: true, ghost: false, articulation: 'normal', surface: 'snare', grace: 0, group: 0 },
        { duration: '1/4', hand: 'L', accent: false, ghost: false, articulation: 'normal', surface: 'snare', grace: 0, group: 1 },
      ],
    },
  ],
}
