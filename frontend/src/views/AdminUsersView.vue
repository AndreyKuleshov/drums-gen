...
async function toggleAdmin(row: AdminUserRow): Promise<void> {
  try {
    ...
    error.value = 'Could not update that user.'
  }
}
    ...
    <div class="console">
      <header class="console__head">
        <div class="brand">
          ...
          <span class="brand__name">Users</span>
        </div>
        <div class="brand__meta">
          <RouterLink to="/admin/ratings" class="nav-link">Ratings</RouterLink>
      ...
      <div v-else class="usertable-wrap">
